...
from lineage_tools import get_lienages_by_lineage_system, get_mutation_profile_by_lineage

def main():
    parser = argparse.ArgumentParser(description="Outbreak API lineage tools dispatcher")
    subparsers = parser.add_subparsers(dest="command", required=True)

    # -- get_lienages_by_lineage_system subcommand
    p_lineages = subparsers.add_parser("get_lienages_by_lineage_system", help="Get lienages by lineage system")
    p_lineages.add_argument("--lineage_system_name", default="PANGO")
    ...
    p_mut_profile.add_argument("--lineage_system_name", default="PANGO")

    args = parser.parse_args()

    if args.command == "get_lienages_by_lineage_system":
        result = get_lienages_by_lineage_system(lineage_system_name=args.lineage_system_name)
